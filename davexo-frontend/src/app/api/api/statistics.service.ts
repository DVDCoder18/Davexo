...
export class StatisticsService extends BaseService {
    ...
    /**
     * Get statistics
     * Returns expense and task statistics for the requested period
     * @endpoint get /api/statistics
     * @param periodType Statistics period type
     * @param startDate Start date of the requested period
     * @param endDate End date of the requested period
    ...
    public getStatistics(periodType: 'DAY' | 'WEEK' | 'MONTH' | 'YEAR', startDate: string, endDate: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (startDate === null || startDate === undefined) {
            throw new Error('Required parameter startDate was null or undefined when calling getStatistics.');
        }
        if (endDate === null || endDate === undefined) {
            throw new Error('Required parameter endDate was null or undefined when calling getStatistics.');
        }
        ...
        let localVarPath = `/api/statistics`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<StatisticsResponseDto>('get', `${basePath}${localVarPath}`,
            {
